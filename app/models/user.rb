class User < ActiveRecord::Base
  ...
  validates :name, :uniqueness => {:case_sensitive => false}, :presence => true,:length => { :minimum => 3,:tokenizer => lambda {|str| str.scan(/[a-z]/i)},:message => "Minimum 3 alphabets should be their "}
